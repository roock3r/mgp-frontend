...
const UploadSix = ({businessPlanId, submissionType, final}) => {
        ...
        return (
            <Accordion>
                <Accordion.Item eventKey="0">
                    <Accordion.Header>Supporting documents you wish to add. (Optional)</Accordion.Header>
                    <Accordion.Body>
                        <Form>
